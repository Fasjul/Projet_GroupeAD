...
public class MultiApplet extends Applet {
	 ...
	 */
	private static final long serialVersionUID = 7114840856226695436L;

	public Vector<Applet> applets = new Vector<Applet>();
	...
	public void start() {
		for (Enumeration<Applet> e=applets.elements(); e.hasMoreElements();) {
			e.nextElement().start();
		}
	}
